...
data_clean <- read_csv(here("course-materials","labs", "data", "Ahmadia_2015_DataClean.csv"), show_col_types = FALSE)
```
...
data_fe <- read_csv(here("course-materials","labs", "data", "Dudney2021_study_data.csv"), show_col_types = FALSE) %>% 
