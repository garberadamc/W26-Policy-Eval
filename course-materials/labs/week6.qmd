...
We propose using **weekly precipitation** as an instrument ($Z$) for PM2.5 ($X$). The logic:
...
#| eval: true
#| echo: false
pm25 <- read_csv(here::here("course-materials", "labs", "data", "daily_pm25_LA.csv")) %>% janitor::clean_names() %>% 
...
2. Given that our first-stage F-statistic was below 10 even without controls, which of the following changes could plausibly strengthen precipitation as an instrument for PM2.5?
