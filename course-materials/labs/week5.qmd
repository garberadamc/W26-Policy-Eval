...
- The assignment variable ($X$): A continuous measure used for assignment
...
sim_data <- read_csv(here("course-materials","labs", "data", "RDD", "Simulated_Deforestation_Data5.csv"), show_col_types = FALSE)
```
